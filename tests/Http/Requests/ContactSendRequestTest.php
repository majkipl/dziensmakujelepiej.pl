...
class ContactSendRequestTest extends ValidationTestCase
{
    ...
    public function validation_pass_for_valid_data()
    {
        ...
        $validator = Validator::make($data, (new ContactSendRequest())->rules());
    ...
    public function validation_fails_if_name_is_not_exists()
    {
        ...
        $this->expectValidationException($data, ContactSendRequest::class);
    }
    ...
    {
        $data = $this->getData([
            'message' => $this->faker->randomNumber(),
        ]);
