...
@section('content')
    ...
    <section id="top" class="product" style="background-image:url({{ 'images/products/shadow.png' }}), url({{ asset('images/products/textures-plus.png') }})">
        <div class="container">
            <h1 class="title">Textures Plus</h1>
