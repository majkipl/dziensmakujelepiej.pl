...
@section('content')
    ...
    <section id="top" class="product" style="background-image:url({{ asset('images/products/shadow.png') }}), url({{ asset('images/products/blender-kielichowy-sensigence.jpg') }})">
        <div class="container">
            <h1 class="title">Blender kielichowy Sensigence</h1>
        </div>
