...
@section('content')
    ...
    <section id="top" class="product" style="background-image:url({{ asset('images/products/shadow.png') }}), url({{ asset('images/products/geo-steel.jpg') }})">
        <video class="video lazy" data-src="{{ asset('mp4/geo-steel.mp4') }}" autoplay="" loop="" muted=""></video>
        <div class="container">
            <h1 class="title">Geo Steel</h1>
        </div>
